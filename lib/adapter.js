...
module.exports = {
          ...
          if (rules.hasOwnProperty('model')) {
            ...
            fields[key] = {
              ...
              resolve: function (object) {
                ...
                return self.defaults.queryFields[pluralize(rules.collection.toLowerCase())].resolve(object, {}, {
                  where: criteria
                });
              }
            };
  ...
  buildQueryFields: function (collection) {
    ...
    fields[pluralize(collectionIdentity.toLowerCase())] = {
    ...
    if (this.defaults.usefulFunctions === true) {
      ...
      fields['getLatest' + pluralize(collectionIdentity)] = {
        type: new GraphQL.GraphQLList(this.defaults.types[collectionIdentity]),
        args: {
          count: {
            name: 'count',
      ...
      fields['getFirst' + pluralize(collectionIdentity)] = {
        type: new GraphQL.GraphQLList(this.defaults.types[collectionIdentity]),
        args: {
          count: {
            name: 'count',
      ...
      fields['count' + pluralize(collectionIdentity)] = {
        type: GraphQL.GraphQLInt,
        resolve: function (object, criteria) {
          const filters = _.omit(handleDateFilter(criteria), function (value) {
            return _.isUndefined(value) || _.isNumber(value) ? _.isNull(value) : _.isEmpty(value);
